...
WebUI.rightClick(findTestObject('Object Repository/Page_OrangeHRM/p_Time at Work'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/div_Aaliyah Haq'), 0, FailureHandling.STOP_ON_FAILURE)
